...
// GOTVG 三国战纪 正宗2012 天下一统 Knights of Valour Plus (Unity Of China 20190314)
// Not working!
static struct BurnRomInfo kovplus2012txRomDesc[] = {
	{ "shuanger2014.dec",   0x400000, 0x0b6e46e6, 1 | BRF_PRG | BRF_ESS },  //  0 68K Code

	{ "t0600x.rom",     	0x800000, 0x629cd466, 2 | BRF_GRA },			//  5 Tile data
	
	{ "a0600.rom",     		0x800000, 0x783df23c, 3 | BRF_GRA },			//  6 Sprite Color Data
	{ "a0601.rom",     		0x800000, 0xff7a4373, 3 | BRF_GRA },			//  7
	{ "a0602.rom",     		0x800000, 0x71c8a46c, 3 | BRF_GRA },			//  8
	{ "a0603x.rom",     	0x400000, 0xa3e2063c, 3 | BRF_GRA },			//  9
	
	{ "b0600.rom",     		0x800000, 0xe3bf000f, 4 | BRF_GRA },			// 10 Sprite Masks & Color Indexes
	{ "b0601.rom",     		0x400000, 0x47a9af9c, 4 | BRF_GRA },			// 11
	
	{ "m0600x.rom",     	0x400000, 0x34c953c2, 5 | BRF_SND },			// 12 Samples	
	
	{ "kov_igs027a.bin", 	0x004000, 0x00000000, 7 | BRF_PRG | BRF_ESS | BRF_NODUMP },  // 13 Internal ARM7 Rom
};

STDROMPICKEXT(kovplus2012tx, kovplus2012tx, pgm)
STD_ROM_FN(kovplus2012tx)

struct BurnDriver BurnDrvkovplus2012tx = {
	"kovplus2012tx", "kovplus", "pgm", NULL, "2019",
	"Knights of Valour Plus (Unity Of China 20190314)\0", NULL, "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM/* | HARDWARE_IGS_USE_ARM_CPU*/, GBF_SCRFIGHT, 0,
	NULL, kovplus2012txRomInfo, kovplus2012txRomName, NULL, NULL, NULL, NULL, pgmInputInfo, kovDIPInfo,
	kovInit, pgmExit, pgmFrame, pgmDraw, pgmScan, &nPgmPalRecalc, 0x900,
	448, 224, 4, 3
};
...
// FBA4DROID 三国战纪 正宗2012 战神无双 天王版 Knights of Valour Plus (Unrivalled God Of War - Sky King 20190414)
static struct BurnRomInfo kovplus2012emtwRomDesc[] = {
	...
	//{ "kov_igs027a.bin", 	0x004000, 0x00000000, 7 | BRF_PRG | BRF_ESS | BRF_NODUMP },  //  Maybe not needed???
};
...
struct BurnDriver BurnDrvkovplus2012emtw = {
	"kovplus2012emtw", "kovplus", "pgm", NULL, "2019",
	"Knights of Valour Plus (Unrivalled God Of War - Sky King 20190414)\0", NULL, "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM/* | HARDWARE_IGS_USE_ARM_CPU*/, GBF_SCRFIGHT, 0,
...
// FBA4DROID 三国战纪 正宗2012 战神ST 天王版 Knights of Valour Plus (God Of War ST - Sky King 20190410)
static struct BurnRomInfo kovplus2012sttwRomDesc[] = {
	{ "p0600.sttw",       	0x400000, 0xed622ddc, 1 | BRF_PRG | BRF_ESS },
...
struct BurnDriver BurnDrvkovplus2012sttw = {
	"kovplus2012sttw", "kovplus", "pgm", NULL, "2019",
	"Knights of Valour Plus (God Of War ST - Sky King 20190410)\0", NULL, "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM/* | HARDWARE_IGS_USE_ARM_CPU*/, GBF_SCRFIGHT, 0,
...
// FBA4DROID 三国战纪 正宗119 秒杀版 Knights of Valour Plus (Seckill Version 20190414)
static struct BurnRomInfo kovplusmsRomDesc[] = {
	{ "p0600.119",     		0x400000, 0x2fe3efe0, 1 | BRF_PRG | BRF_ESS },  //  0 68K Code
...
struct BurnDriver BurnDrvkovplusms = {
	"kovplusms", "kovplus", "pgm", NULL, "2019",
	"Knights of Valour Plus (Seckill Version 20190414)\0", NULL, "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM/* | HARDWARE_IGS_USE_ARM_CPU*/, GBF_SCRFIGHT, 0,
...
// FBA4DROID 三国战纪 2017 噩梦战神 Knights of Valour Plus (Warlord Of Nightmare 20170420)
// Not working !!!
static struct BurnRomInfo kovemzsRomDesc[] = {
	{ "p0600.em",     		0x400000, 0x0b14d9fa, 1 | BRF_PRG | BRF_ESS },  //  0 68K Code
...
struct BurnDriver BurnDrvkovemzs = {
	...
	"Knights of Valour Plus (Warlord Of Nightmare 20170420)\0", NULL, "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM/* | HARDWARE_IGS_USE_ARM_CPU*/, GBF_SCRFIGHT, 0,
...
// FBA4DROID 三国战纪 2017 三国战纪 2017 噩梦战神 天王版  Knights of Valour Plus (Warlord Of Nightmare - Sky King 20190410)
// Not working !!!
static struct BurnRomInfo kovemzstwRomDesc[] = {
	{ "p0600.emtw",     		0x400000, 0x48751546, 1 | BRF_PRG | BRF_ESS },  //  0 68K Code
...
struct BurnDriver BurnDrvkovemzstw = {
	"kovemzstw", "kovplus", "pgm", NULL, "2019",
	"Knights of Valour Plus (Warlord Of Nightmare - Sky King 20190410)\0", NULL, "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM/* | HARDWARE_IGS_USE_ARM_CPU*/, GBF_SCRFIGHT, 0,
...
// FBA4DROID 三国战纪 2012 噩梦战神 Knights of Valour Plus (Warlord Of Nightmare 20190417)
// Not working!
static struct BurnRomInfo kovemzs2019RomDesc[] = {
	{ "t0601X.rom",	0x200000, 0x89b79e94, 1 | BRF_PRG | BRF_ESS },  //  0 68K Code
	{ "t0602X.rom",	0x200000, 0x9697e436, 1 | BRF_PRG | BRF_ESS },  //  0 68K Code
...
struct BurnDriver BurnDrvkovemzs2019 = {
	"kovemzs2019", "kovplus", "pgm", NULL, "2019",
	"Knights of Valour Plus (Warlord Of Nightmare 20190417)\0", NULL, "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM/* | HARDWARE_IGS_USE_ARM_CPU*/, GBF_SCRFIGHT, 0,
...
struct BurnDriver BurnDrvkovcxzz = {
	"kovcxzz", "kovplus", "pgm", NULL, "2019",
	"Knights of Valour Plus (Work Of Initial Heart 20190415)\0", NULL, "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM/* | HARDWARE_IGS_USE_ARM_CPU*/, GBF_SCRFIGHT, 0,
...
// FBA4DROID 三国战纪 乱世枭雄 惊天战神 2019 Knights of Valour Super Heroes Plus (Incredible God of War 20190624)
static struct BurnRomInfo kovshp1v4xRomDesc[] = {
	{ "m0601.rom",			0x200000, 0x4bc18e5b, 1 | BRF_PRG | BRF_ESS },  //  0 68K Code
	{ "m0602.rom",			0x200000, 0xf8d2821f, 1 | BRF_PRG | BRF_ESS },  //  1 68K Code
...
struct BurnDriver BurnDrvkovshp1v4x = {
	...
	"Knights of Valour Super Heroes Plus (Incredible God of War 20190624)\0", "Imperfect Protection Emulation", "IGS", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
...
// FBA4DROID 三国战纪 乱世枭雄 群雄再起 终极天王 Knights of Valour Super Heroes Plus (Rerise of Heroes - Ultimate Sky King 20190406)
// Not working!
static struct BurnRomInfo kovshpqxzqztwRomDesc[] = {
	{ "p0600h.rom",			0x600000, 0x1a849ff0, 1 | BRF_PRG | BRF_ESS },  //  0-1 68K Code
	...
	{ "b0540.rom",	   		0x800000, 0xb7032905, 4 | BRF_GRA },			//  7-1
	{ "b0601.rom",	   		0x800000, 0x095378f3, 4 | BRF_GRA }, 	        //  7-2 Expanded ROM

	{ "m0600.rom",	   		0x400000, 0xec3f335d, 5 | BRF_SND },			//  8 Samples

	{ "kovsh_v100_china.asic", 	0x004000, 0xd9a43086, 7 | BRF_PRG | BRF_ESS },  //  9 Internal ARM7 Rom
};

STDROMPICKEXT(kovshpqxzqztw, kovshpqxzqztw, pgm)
STD_ROM_FN(kovshpqxzqztw)

struct BurnDriver BurnDrvkovshpqxzqztw = {
	"kovshpqxzqztw", "kovshp", "pgm", NULL, "2019",
	"Knights of Valour Super Heroes Plus (Rerise of Heroes - Ultimate Sky King 20190406)\0", "Imperfect Protection Emulation", "IGS", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
	NULL, kovshpqxzqztwRomInfo, kovshpqxzqztwRomName, NULL, NULL, NULL, NULL, pgmInputInfo, kovshxasDIPInfo,
	kovshxasInit, pgmExit, pgmFrame, pgmDraw, pgmScan, &nPgmPalRecalc, 0x900,
	448, 224, 4, 3
};
...
// FBA4DROID 三国战纪 乱世英雄 群雄逐鹿 天王版 Knights of Valour Super Heroes Plus (Powerful Politicians Fighting For Supremacy - Sky King 20190418)
static struct BurnRomInfo kovshpd3twRomDesc[] = {
	{ "p0600h.rom",			0x4004b2, 0x1fa694c6, 1 | BRF_PRG | BRF_ESS },  // Incorrect size ???
...
struct BurnDriver BurnDrvkovshpd3tw = {
	...
	"Knights of Valour Super Heroes Plus (Powerful Politicians Fighting For Supremacy - Sky King 20190418)\0", "Imperfect Protection Emulation", "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
...
// FBA4DROID 三国战纪 乱世枭雄 秒杀版  Knights of Valour Super Heroes Plus  (Seckill Version 20190414)
...
struct BurnDriver BurnDrvkovshpms = {
	...
	"Knights of Valour Super Heroes Plus  (Seckill Version 20190414)\0", "Imperfect Protection Emulation", "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
...
static struct BurnRomInfo kovassga3RomDesc[] = {
	...
	//{ "a0603.rom",	   		0x400000, 0xec31abda, 3 | BRF_GRA }, 	        //  ??? unneeded file?

	{ "b0600.rom",	   		0x800000, 0x7d3cd059, 4 | BRF_GRA },			//  6 Sprite Masks & Color Indexes
	{ "b0540.rom",	   		0x800000, 0x1885039b, 4 | BRF_GRA },			//  7
	//{ "b0601.rom",	   		0x400000, 0xa0bb1c2f, 4 | BRF_GRA },			//  ??? unneeded file?
...
// FBA4DROID 三国战纪 乱世英雄 群雄逐鹿之盖世枭雄 Knights of Valour Super Heroes Plus (Powerful Politicians Fighting For Supremacy - Heroes 20190501)
static struct BurnRomInfo kovshpd3gsRomDesc[] = {
	{ "m6001.rom",  		0x200000, 0x07575b97, 1 | BRF_PRG | BRF_ESS },  //  0 68K Code
	{ "m6002.rom",  		0x200000, 0x889587ee, 1 | BRF_PRG | BRF_ESS },  //  0 68K Code
	...
	{ "p0600h.rom",	   		0x400000, 0xec3f335d, 5 | BRF_SND },	        //  9 Samples

	{ "kovshp_v100_china.asic",	0x004000, 0xd9a43086, 7 | BRF_PRG | BRF_ESS },  //  10 Internal ARM7 Rom
};
...
struct BurnDriver BurnDrvkovshpd3gs = {
	"kovshpd3gs", "kovshp", "pgm", NULL, "2019",
	"Knights of Valour Super Heroes Plus (Powerful Politicians Fighting For Supremacy - Heroes 20190501)\0", "Imperfect Protection Emulation", "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
...
struct BurnDriver BurnDrvkov2pmemm = {
	"kov2pmemm", "kov2p", "pgm", NULL, "2001",
	"Knights of Valour 2 Plus (Tian Huo Ming Ming 20190415)\0", NULL, "IGS", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM | HARDWARE_IGS_USE_ARM_CPU, GBF_SCRFIGHT, 0,
...
// Knights of Valour Plus - Sangoku Senki Plus (V119 Charge Faster)
// 月光宝盒 三国战纪集气快
...
struct BurnDriver BurnDrvkovplusf = {
	...
	"Knights of Valour Plus - Sangoku Senki Plus (V119 Charge Faster)\0", NULL, "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM/* | HARDWARE_IGS_USE_ARM_CPU*/, GBF_SCRFIGHT, 0,
...
// Knights of Valour Plus - Sangoku Senki Plus (2007 Charge Faster)
// 月光宝盒 三国战纪2007集气快
...
struct BurnDriver BurnDrvkovplusf2 = {
	...
	"Knights of Valour Plus - Sangoku Senki Plus (2007 Charge Faster)\0", NULL, "hack", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM/* | HARDWARE_IGS_USE_ARM_CPU*/, GBF_SCRFIGHT, 0,
