...
static struct BurnDIPInfo grdiansDIPList[] = {
	...
	// DIP 1
	{0,		0xFE, 0,	4,	  "难度"},
	{0x15,	0x01, 0x03, 0x01, "简单"},
	{0x15,	0x01, 0x03, 0x00, "普通"},
	{0x15,	0x01, 0x03, 0x02, "困难"},
	{0x15,	0x01, 0x03, 0x03, "最难"},
//	{0,		0xFE, 0,	2,	  "Unknown"},
//	{0x15,	0x01, 0x04,	0x00, "Off"},
//	{0x15,	0x01, 0x04,	0x04, "On"},
	{0,		0xFE, 0,	2,	  "标题"},
	{0x15,	0x01, 0x08,	0x00, "守护者"},
	{0x15,	0x01, 0x08,	0x08, "电神魔傀II"},
	{0,		0xFE, 0,	4,	  "命数"},
...
static struct BurnDIPInfo pzlbowlDIPList[] = {
	...
	{0x15,	0x01, 0x38, 0x18, "简单"},
	{0x15,	0x01, 0x38, 0x00, "普通"},
	{0x15,	0x01, 0x38, 0x20, "困难"},
	{0x15,	0x01, 0x38, 0x28, "更难"},
	{0x15,	0x01, 0x38, 0x30, "非常困难"},
	{0x15,	0x01, 0x38, 0x38, "最难"},
...
//	{0x16,	0x01, 0x40, 0x40, "On"},
	{0,		0xFE, 0,	2,	  "语言"},
	{0x16,	0x01, 0x80, 0x00, "日语"},
	{0x16,	0x01, 0x80, 0x80, "英语"},
...
static struct BurnDIPInfo penbrosDIPList[] = {
	...
	{0,		0xFE, 0,	2,	  "Screen"},
	{0x13,	0x01, 0x02, 0x00, "普通"}, 
	{0x13,	0x01, 0x02, 0x02, "反转"},
	{0,		0xFE, 0,	2,	  "Demo声音"},
	...
	// DIP 2
	{0,		0xFE, 0,	4,	  "难度"},
	{0x14,	0x01, 0x03, 0x01, "简单"},
	{0x14,	0x01, 0x03, 0x00, "普通"},
	{0x14,	0x01, 0x03, 0x02, "困难"},
	{0x14,	0x01, 0x03, 0x03, "非常困难"},
	{0,		0xFE, 0,	4,	  "命数"},
	...
	{0,		0xFE, 0,	4,	  "奖命"},
	{0x14,	0x01, 0x30, 0x20, "150000, 500000点"},
	{0x14,	0x01, 0x30, 0x00, "200000, 700000点"},
	{0x14,	0x01, 0x30, 0x30, "每250000点"},
	{0x14,	0x01, 0x30, 0x10, "不奖命"},
	{0,		0xFE, 0,	4,	  "局数"},
...
static struct BurnDIPInfo GundamexDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "难度"		},
	{0x16, 0x01, 0x06, 0x04, "简单"		},
	{0x16, 0x01, 0x06, 0x06, "普通"		},
	{0x16, 0x01, 0x06, 0x02, "困难"		},
	{0x16, 0x01, 0x06, 0x00, "最难"		},
	...
	{0   , 0xfe, 0   ,    2, "语言"		},
	{0x18, 0x01, 0x20, 0x20, "英语"		},
	{0x18, 0x01, 0x20, 0x00, "日语"		},
};
...
static struct BurnDIPInfo DeerhuntDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "难度"		},
	{0x0b, 0x01, 0x18, 0x10, "简单"		},
	{0x0b, 0x01, 0x18, 0x18, "普通"		},
	{0x0b, 0x01, 0x18, 0x08, "困难"		},
	{0x0b, 0x01, 0x18, 0x00, "最难"		},

	{0   , 0xfe, 0   ,    2, "血色"		},
	{0x0b, 0x01, 0x20, 0x20, "红色"		},
	{0x0b, 0x01, 0x20, 0x00, "黄色"		},
...
static struct BurnDIPInfo WschampDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "难度"		},
	{0x13, 0x01, 0x18, 0x10, "简单"		},
	{0x13, 0x01, 0x18, 0x18, "普通"		},
	{0x13, 0x01, 0x18, 0x08, "困难"		},
	{0x13, 0x01, 0x18, 0x00, "最难"		},
...
static struct BurnDIPInfo TrophyhDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    2, "血色"		},
	{0x13, 0x01, 0x20, 0x20, "红色"		},
	{0x13, 0x01, 0x20, 0x00, "黄色"		},
